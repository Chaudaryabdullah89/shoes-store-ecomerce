            ...
            {filteredBlogs.map((blog) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6 flex flex-col h-full">
                  ...
                  <Link
                    to={`/blog/${blog._id}`}
                    className="mt-auto inline-flex items-center text-black font-medium text-xs sm:text-sm hover:text-gray-700 transition-colors border border-black px-3 sm:px-4 py-1.5 sm:py-2 rounded-md hover:bg-gray-50"
                  >
                    Read More 
