...
const Login = () => {
  ...
  // Social login: open backend OAuth endpoint in new window
  const handleSocialLogin = (provider) => {
    setIsLoading(true);
    // You should have backend endpoints like /auth/google and /auth/facebook
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
